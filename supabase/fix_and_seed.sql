-- ============================================================
-- STEP 1 — Diagnose: run this SELECT first to see what's in DB
-- ============================================================
...
-- ============================================================
-- STEP 2 — Re-insert the 48 real matches (safe: DELETE + INSERT)
-- WARNING: also deletes all predictions via CASCADE.
-- Only run if no real user predictions exist yet.
-- ============================================================
