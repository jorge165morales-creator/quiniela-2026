-- ============================================================
-- FIFA World Cup 2026 — Real Group Stage Schedule
-- Run this in your Supabase SQL Editor to replace placeholder matches.
-- All times in UTC. Draw held December 5, 2024.
-- All 48 teams confirmed (April 2026). Team names in Spanish.
-- ============================================================

-- Remove existing matches (cascades to predictions — only run before predictions are submitted!)
-- If users have already submitted predictions, comment out the DELETE and use UPDATE instead.
